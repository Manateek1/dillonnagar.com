...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/8 bg-[#0a0a0a]/90 backdrop-blur-sm">
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-white/8 bg-[#0a0a0a] px-6 py-4 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 pt-2 border-t border-white/8">
            <a href="https://github.com/Manateek1" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white">
              <GithubIcon />
            </a>
